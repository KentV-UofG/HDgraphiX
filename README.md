...
Of note, this script is older and does not have every feature currently available on the website or in the new code. Additionally, this script only recognizes DynamX cluster files, and not outputs from HDeXaminer/HDX Workbench. A seperate python script has been provided to convert HDeXaminer files to DynamX.
